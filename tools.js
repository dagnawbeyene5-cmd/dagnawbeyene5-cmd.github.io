...
import {
  initQr, initUnitConverter, initPalette, initMarkdown,
  initJsonFormatter, initWordCounter, initBase64, initTimestamp, initImageCompressor,
} from './modules/toolsMore.js';
